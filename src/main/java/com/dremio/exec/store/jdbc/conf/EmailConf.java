...
@SourceType(value = "EmailARP", label = "Email",uiConfig = "email-layout.json")
public class EmailConf extends AbstractArpConf<EmailConf> {
  private static final String ARP_FILENAME = "arp/implementation/email-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.email.EmailDriver";
